...
Vivid is undoubtedly my passion project. Born while working night shifts at my first job, it's the first real giant project I tackled on. Designed solely by me without referring to other existing image organizers and minimal use of frameworks and libraries.
